  ...
  return (
    <Animated.View entering={FadeInUp.delay(200).duration(400)} style={styles.tabContainer}>
      <View style={styles.tabSwitcher}>
        <Animated.View
          style={[styles.tabButtonActiveIndicator, animatedIndicatorStyle, { backgroundColor: THEME.orchidMain }]}
        />
        <TouchableOpacity style={styles.tabButton} onPress={() => onTabChange('zones')} activeOpacity={0.8}>
          <Text style={[styles.tabButtonText, activeTab === 'zones' && { color: '#FFFFFF' }]}>My Zones</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.tabButton} onPress={() => onTabChange('plants')} activeOpacity={0.8}>

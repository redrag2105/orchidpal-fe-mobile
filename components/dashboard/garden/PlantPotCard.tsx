    ...
    >
      ...
      <View style={styles.potWrapper}>
        <Svg width={80} height={62} viewBox="0 0 90 70">
          ...
          <Path
            d="M 5 5 L 85 5 L 85 62 Q 85 70 75 70 L 15 70 Q 5 70 5 62 Z"
            fill="url(#potInner)"
          />
          ...
          */}
          <Path
            d="M 5 5 L 16 5 L 14 68 Q 10 67 5 62 Z"
            fill="url(#slatMain)"
          />
          <Path d="M 16 5 L 18 5 L 16 69 L 14 68 Z" fill="url(#gapShadow)" />

          <Path
            d="M 18 5 L 30 5 L 28 70 L 16 69 Z"
            fill="url(#slatMain)"
          />
          <Path d="M 30 5 L 32 5 L 30 70 L 28 70 Z" fill="url(#gapShadow)" />

          <Path
            d="M 32 5 L 44 5 L 43 70 L 30 70 Z"
            fill="url(#slatMain)"
          />
          <Path d="M 44 5 L 46 5 L 45 70 L 43 70 Z" fill="url(#gapShadow)" />

          <Path
            d="M 46 5 L 58 5 L 59 70 L 45 70 Z"
            fill="url(#slatMain)"
          />
          <Path d="M 58 5 L 60 5 L 61 70 L 59 70 Z" fill="url(#gapShadow)" />

          <Path
            d="M 60 5 L 72 5 L 74 69 L 61 70 Z"
            fill="url(#slatMain)"
          />
          <Path d="M 72 5 L 74 5 L 76 68 L 74 69 Z" fill="url(#gapShadow)" />

          <Path
            d="M 74 5 L 85 5 L 85 62 Q 85 67 78 69 L 76 68 Z"
            fill="url(#slatMain)"
          />
          
          {/* Pot Rim */}
          <Path
            d="M 0 0 L 90 0 L 90 5 Q 90 8 87 8 L 3 8 Q 0 8 0 5 Z"
            fill="#8B4513"
          />
          <Path
            d="M 3 6 L 87 6 L 87 8 L 3 8 Z"
            fill="#5C2E0B"
            opacity={0.5}
          />
        </Svg>
        ...
        <View style={styles.signContainer}>
          ...
          <View style={styles.signBoard}>
            <Text style={styles.signText} numberOfLines={2}>{plant.nickname}</Text>
          </View>
        </View>
      </View>

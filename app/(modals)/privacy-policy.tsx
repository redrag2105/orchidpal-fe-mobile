  ...
  return (
    <SafeAreaView style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.p}>
          We collect information from you when you register on our app, place an order, subscribe to our newsletter,
          respond to a survey, fill out a form, or use our IoT devices.
        </Text>
        ...
        <Text style={styles.p}>
          ...
          experience, to improve our app, to improve customer service, to process transactions, or to send periodic
          emails.
        </Text>

    ...
    <SafeAreaView style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.a}>
            Go to the Devices tab or Settings, and tap 'Add New Device'. Follow the on-screen instructions to connect
            your IoT kit.
          </Text>
        </View>
        <View style={styles.card}>
          ...
          <Text style={styles.a}>
            AI Chat allows you to ask questions about your plants, upload photos for diagnosis, and receive expert
            botanical advice.
          </Text>
        </View>
        <View style={styles.card}>
          ...
          <Text style={styles.a}>
            Navigate to the Garden tab, select your plant, and choose 'Edit Zone' from the plant details screen.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
